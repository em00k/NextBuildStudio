...
#line 3 "arch/zxnext/codebank_at_numeric.bas"
_r:
	DEFB 00
...
__ARRAY_BUFFER:
	    ...
	    ENDP
	    pop namespace
#line 42 "arch/zxnext/codebank_at_numeric.bas"
...
__FAR_INIT:
	        ...
	        ret
	    pop namespace
#line 43 "arch/zxnext/codebank_at_numeric.bas"
	CODEBANK 1
#line 6 "arch/zxnext/codebank_at_numeric.bas"
	_scr.__DATA__ EQU 16384
_scr:
	DEFW .LABEL.__LABEL0
_scr.__DATA__.__PTR__:
	DEFW 16384
	DEFW 0
	DEFW 0
.LABEL.__LABEL0:
