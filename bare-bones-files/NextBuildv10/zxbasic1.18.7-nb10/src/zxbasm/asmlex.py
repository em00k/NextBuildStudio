...
# ZX Next only pseudo-ops. Kept out of `pseudo` so they stay ordinary
# identifiers for the zx48k target, and so existing sources that use e.g.
# `codebank` as a label are unaffected unless --arch=zxnext is in play.
zx_next_pseudo = {"codebank": "CODEBANK"}
