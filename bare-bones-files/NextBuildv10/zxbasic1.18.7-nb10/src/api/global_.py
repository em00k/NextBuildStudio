...
# ZX Next: SUBs synthesised to run a bank-local variable's delayed
# initialisation inside its own bank. Only kept so the names stay unique; the
# routines reach FUNCTIONS the ordinary way, through their FUNCDECL node.
# See zxbparser._delayed_init.
FUNCTIONS_BANKINIT: list[SymbolID] = []
