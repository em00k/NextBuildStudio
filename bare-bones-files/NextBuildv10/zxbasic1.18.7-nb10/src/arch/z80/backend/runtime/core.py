...
class CoreLabels:
    ...
    FAR_CALL = f"{NAMESPACE}.__FAR_CALL"
    FAR_INIT = f"{NAMESPACE}.__FAR_INIT"
    FAR_RETURN = f"{NAMESPACE}.__FAR_RETURN"
...
REQUIRED_MODULES = {
    ...
    CoreLabels.FAR_CALL: "farcall.asm",
    CoreLabels.FAR_INIT: "farcall.asm",
    CoreLabels.FAR_RETURN: "farcall.asm",
