...
class SymbolRef:
    ...
    __slots__ = "_accessed", "_t", "addr", "callable", "has_faraddress", "offset", "parent"
    ...
    def __init__(self, parent: SymbolID):
        ...
        self.offset = None
        # ZX Next: whether a FARPTR names this symbol. If it does, and the
        # symbol is bank-local, the bank pass emits a FAR_ADDR_SUFFIX alias
        # label beside its storage for the pointer to name. Set at parse time
        # (zxbparser.make_faraddress) and read at translate time, by which
        # point every bank is settled.
        self.has_faraddress = False
