...
def parse_args():
    ...
    parser.add_argument('-a',
                        ...
                        action='store_true',
                        dest='autostart',
                        help='Set autostart for the loader')
    parser.add_argument('-m',
                        '--makebin',
                        action='store_true',
                        dest='makebin',
                        help='Make a binary loader instead of a NEX loader')
    ...
    values['autostart'] = 1 if autostart else 0
    values['makebin'] = 1 if makebin else 0
