...
UART_FRAME_163B                 equ $163B   ; UART FRAME Write
...
INTERRUPT_CONTROL_NR_C0             equ $C0
INTERRUPT_ENABLE_0_REGISTER_NR_C4   equ $C4
INTERRUPT_ENABLE_1_REGISTER_NR_C5   equ $C5
INTERRUPT_ENABLE_2_REGISTER_NR_C6   equ $C6
INTERRUPT_STATUS_0_REGISTER_NR_C8   equ $C8
INTERRUPT_STATUS_1_REGISTER_NR_C9   equ $C9
INTERRUPT_STATUS_2_REGISTER_NR_CA   equ $CA
DMA_INTERRUPT_ENABLE_0_NR_CC    equ $CC
DMA_INTERRUPT_ENABLE_1_NR_CD    equ $CD
DMA_INTERRUPT_ENABLE_2_NR_CE    equ $CE
