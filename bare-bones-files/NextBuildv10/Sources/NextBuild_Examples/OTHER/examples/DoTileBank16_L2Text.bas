'!ORG=24576
' This is how we assign a loading image to the NEX file
' There will be a pause for a few seconds to appreciate the 
' artwork 
...
LoadSDBank("[]font25.fnt",0,0,0,40) ' load our font to bank 40 
