...
#include <nextlib_ints.bas>         ' include the interrtup library
'
...
Print ink 5;at 0,0;"The following var is incremented" : print "with the custom ISR"

do 

	WaitRetrace(1)								' use instead of pause 1 
    Print ink 6;at 4,0;tt;"   "                 ' add space to clear chars 
