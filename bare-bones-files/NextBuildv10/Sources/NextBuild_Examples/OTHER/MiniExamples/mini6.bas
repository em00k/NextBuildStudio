...
LoadBMP("spiral.bmp")
NextReg($15,%00000001) 
ClipLayer2(0,255,0,182)		'definimos la superficie del layer 2, dejando un hueco abajo para una línea de texto de la ULA		
ShowLayer2(1)

print at 23,4;"Este es el layer de ULA"
