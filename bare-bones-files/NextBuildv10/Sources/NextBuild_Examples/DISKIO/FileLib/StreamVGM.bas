...
' Plays both uncompressed VGM & PSG audio dumps
' Not 100% accurate, but good enough for most purposes.
' Demonstrates the streaming ability ussing FileLib
...
LoadSDBank("[]font24.fnt",0,0,0,34)
...
dim is_vgm      as ubyte = 1                      ' Flag to indicate VGM format
