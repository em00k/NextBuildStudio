...
const BAR_THICKNESS as ubyte = 8
const BAR_EVENTS as ubyte = 8
const BAR_SPACING as ubyte = 32
const BAR_COUNT as ubyte = 4
const COPPER_BARS_LENGTH as uinteger = 110  ' use length shown by the app
  ...
  sub UpdateCopperData()
      ...
      for bar = 0 to BAR_COUNT - 1
          for part = 0 to BAR_EVENTS - 1
              ...
              line = copper_data_offset + cast(uinteger, bar * BAR_SPACING) + bar_line_ofs(part)
              line = line band 255
