...
do 
    '         x y image      frame 
    DrawImage(0,0,@image_128,0)             ' colour wheel 1
    WaitKey()
    DrawImage(10,10,@image_128,1)           ' zx next test 
    WaitKey()
    DrawImage(20,20,@image_128,2)           ' parrot
    WaitKey()
    DrawImage(30,30,@image_128,3,0)         ' colour wheel 2, transparancy on colour 0
    WaitKey()
